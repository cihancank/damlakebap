...
export default function MenuPage() {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      description: "Küçük boy geleneksel lahmacun",
      price: 100,
      image: "/images/findik-lahmacun-new.jpg",
      category: "lahmacun",
    ...
    // Pideler
    {
      id: "bafra-pide",
      name: "Bafra Pide",
      description: "Karadeniz usulü özel Bafra pidesi, tereyağlı",
      price: 375,
      image: "/images/bafra-pide-new.jpg",
      category: "pideler",
    ...
    },
    {
      ...
      price: 475,
      image: "/images/pastirmali-pide-new.jpg",
      category: "pideler",
      preparationTime: "18-23 dk",
      rating: 4.7,
    },

    // Kebaplar - Et Şiş / Kuzu Şiş / Karışık
    {
      id: "et-sis",
      name: "Et Şiş",
      description: "Marine edilmiş kuşbaşı dana eti şiş kebabı",
      price: 600,
      image: "/images/et-sis-new.jpg",
      category: "kebaplar",
    ...
    },
    {
      id: "kuzu-sis",
      name: "Kuzu Şiş",
      description: "Tender and juicy lamb shish kebab on charcoal",
      price: 700,
      image: "/images/kuzu-sis-new.jpg",
      category: "kebaplar",
    ...
    },
    {
      id: "catir-tavuk",
      name: "Çatır Tavuk",
      description: "Çıtır çıtır dış kabuğuyla özel tavuk",
      price: 475,
      image: "/images/citir-kanat-new.jpg",
      category: "kebaplar",
      preparationTime: "18-22 dk",
      rating: 4.5,
    },
    ...
    },
    {
      id: "citir-kanat",
      name: "Çıtır Kanat",
      description: "Altın rengi çıtır çıtır pişirilmiş tavuk kanat",
      price: 475,
      image: "/images/citir-kanat-new.jpg",
      category: "kebaplar",
      preparationTime: "18-22 dk",
    ...
    },
    {
      ...
      name: "İskender",
      description: "Tereyağlı, yoğurtlu özel İskender kebabı",
      price: 600,
    ...
    },
    {
      id: "fistikli-kebap",
      name: "Fıstıklı Kebap",
      description: "Antep fıstığı karışımlı özel kebap",
      price: 700,
      image: "/images/fistikli-kebap-new.jpg",
      category: "kebaplar",
      preparationTime: "25-30 dk",
      rating: 4.7,
    },
    {
      ...
      price: 700,
      image: "/images/cevizli-kebap-new.jpg",
      category: "kebaplar",
      preparationTime: "25-30 dk",
      rating: 4.6,
    },
    {
      id: "ciger-sis",
      name: "Ciğer Şiş",
      description: "Közde pişirilmiş kuzu ciğer şiş kebabı",
      price: 600,
      image: "/images/ciger-sis-new.jpg",
      category: "kebaplar",
      preparationTime: "18-22 dk",
      rating: 4.5,
    },
    ...
    },
    {
      ...
      price: 375,
      image: "/images/ciger-durum-new.jpg",
      category: "durum",
      preparationTime: "15-20 dk",
      rating: 4.5,
    },
    {
      ...
      price: 375,
      image: "/images/et-sis-durum-new.jpg",
      category: "durum",
      preparationTime: "15-20 dk",
      rating: 4.6,
    },
    {
      ...
      price: 400,
      image: "/images/kuzu-sis-durum-new.jpg",
      category: "durum",
      preparationTime: "15-20 dk",
      rating: 4.6,
    },
    ...
    // Mezeler & Salatalar
    {
      id: "cacik",
      name: "Cacık",
      description: "Yoğurt, salatalık, sarımsak ve dereotu",
      price: 175,
      image: "/images/cacik-new.jpg",
      category: "mezeler",
      preparationTime: "5-10 dk",
      rating: 4.5,
      isVegetarian: true,
    },
    {
      ...
      description: "Közlenmiş patlıcan, yoğurt ve sarımsak",
      price: 200,
      image: "/images/yogurtlu-koz-patlican-new.jpg",
      category: "mezeler",
      preparationTime: "8-12 dk",
      rating: 4.6,
      isVegetarian: true,
