...
const sections: SettingSection[] = [
  ...
  {
    id: "testimonials",
    title: "Ana Sayfa — Müşteri Yorumları",
    fields: [
      { key: "testimonials_title", label: "Bölüm Başlığı", type: "textarea", placeholder: "Müşterilerimiz Damla Kebap Hakkında Ne Diyor?" },
      { key: "testimonials_subtitle", label: "Alt Başlık", type: "text", placeholder: "16 yıllık deneyimimizin müşteri memnuniyetine yansıması" },
      { key: "testimonials_stat1_value", label: "İstatistik 1 Değer", type: "text", placeholder: "4.8" },
      { key: "testimonials_stat1_label", label: "İstatistik 1 Etiket", type: "text", placeholder: "Ortalama Puan" },
      { key: "testimonials_stat2_value", label: "İstatistik 2 Değer", type: "text", placeholder: "1000+" },
      { key: "testimonials_stat2_label", label: "İstatistik 2 Etiket", type: "text", placeholder: "Mutlu Müşteri" },
      { key: "testimonials_stat3_value", label: "İstatistik 3 Değer", type: "text", placeholder: "16" },
      { key: "testimonials_stat3_label", label: "İstatistik 3 Etiket", type: "text", placeholder: "Yıllık Deneyim" },
      { key: "testimonials_review_url", label: "Tüm Yorumlar Linki", type: "url", placeholder: "https://g.page/damla-kebap-atasehir/review" },
      { key: "testimonials_r1_name", label: "Yorum 1 — İsim", type: "text", placeholder: "Ayşe Y." },
      { key: "testimonials_r1_location", label: "Yorum 1 — Konum", type: "text", placeholder: "Ataşehir" },
      { key: "testimonials_r1_text", label: "Yorum 1 — Metin", type: "textarea" },
      { key: "testimonials_r2_name", label: "Yorum 2 — İsim", type: "text", placeholder: "Mehmet D." },
      { key: "testimonials_r2_location", label: "Yorum 2 — Konum", type: "text", placeholder: "Küçükbakkalköy" },
      { key: "testimonials_r2_text", label: "Yorum 2 — Metin", type: "textarea" },
      { key: "testimonials_r3_name", label: "Yorum 3 — İsim", type: "text", placeholder: "Zeynep K." },
      { key: "testimonials_r3_location", label: "Yorum 3 — Konum", type: "text", placeholder: "Ataşehir" },
      { key: "testimonials_r3_text", label: "Yorum 3 — Metin", type: "textarea" },
      { key: "testimonials_r4_name", label: "Yorum 4 — İsim", type: "text", placeholder: "Ali R." },
      { key: "testimonials_r4_location", label: "Yorum 4 — Konum", type: "text", placeholder: "Ataşehir" },
      { key: "testimonials_r4_text", label: "Yorum 4 — Metin", type: "textarea" },
      { key: "testimonials_r5_name", label: "Yorum 5 — İsim", type: "text", placeholder: "Fatma S." },
      { key: "testimonials_r5_location", label: "Yorum 5 — Konum", type: "text", placeholder: "Yenişehir" },
      { key: "testimonials_r5_text", label: "Yorum 5 — Metin", type: "textarea" },
      { key: "testimonials_r6_name", label: "Yorum 6 — İsim", type: "text", placeholder: "Osman T." },
      { key: "testimonials_r6_location", label: "Yorum 6 — Konum", type: "text", placeholder: "Ataşehir" },
      { key: "testimonials_r6_text", label: "Yorum 6 — Metin", type: "textarea" },
    ],
  },
  {
    id: "contact",
    title: "İletişim Bölümü & Bize Ulaşın",
    fields: [
      { key: "contact_section_title", label: "Bölüm Başlığı", type: "text", placeholder: "Bize Ulaşın" },
      { key: "contact_location_title", label: "Konum Başlığı", type: "text", placeholder: "Damla Kebap Ataşehir" },
      { key: "contact_address", label: "Adres", type: "text" },
      { key: "contact_maps_url", label: "Google Maps Yol Tarifi Linki", type: "url", placeholder: "https://g.co/kgs/cQVWqD2" },
      { key: "contact_phone1", label: "Telefon 1", type: "text", placeholder: "+90 216 456 37 90" },
      { key: "contact_phone2", label: "Telefon 2", type: "text", placeholder: "+90 216 456 37 91" },
      { key: "contact_email", label: "E-posta", type: "text" },
      { key: "contact_hours_weekday", label: "Hafta İçi Saatleri", type: "text", placeholder: "Pazartesi-Cumartesi: 11:00 - 23:00" },
      { key: "contact_hours_weekend", label: "Hafta Sonu Saatleri", type: "text", placeholder: "Pazar: 12:00 - 22:00" },
  ...
  },
  {
    ...
    title: "Footer",
    fields: [
      { key: "footer_location", label: "Şehir / Konum Etiketi", type: "text", placeholder: "Ataşehir, İstanbul" },
      { key: "footer_tagline", label: "Slogan / Açıklama", type: "textarea" },
      { key: "footer_address", label: "Adres", type: "text" },
      { key: "footer_phone1", label: "Telefon 1", type: "text", placeholder: "+90 216 456 37 90" },
      { key: "footer_phone2", label: "Telefon 2", type: "text", placeholder: "+90 216 456 37 91" },
      { key: "footer_email", label: "E-posta", type: "text" },
      { key: "footer_hours", label: "Çalışma Saatleri", type: "text", placeholder: "Pazartesi-Pazar: 10:00 - 01:00" },
